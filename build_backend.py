...
def main() -> int:
    ...
    cmd = [
        ...
        str(ROOT),
        "--add-data",
        f"app/resources/sql/bootstrap_sqlite.sql{';' if sys.platform == 'win32' else ':'}app/resources/sql",
        "--add-data",
        f"app/resources/sql/bootstrap_postgres.sql{';' if sys.platform == 'win32' else ':'}app/resources/sql",
        "--hidden-import",
        "uvicorn.logging",
        "--hidden-import",
        "uvicorn.loops.auto",
